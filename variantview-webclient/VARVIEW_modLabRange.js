// This code is heavily borrowed from GIRI plugin
// which in turn was adapted from Timeline_mobLabRange.js
i2b2.VARVIEW.view.modalLabValues = {
	formdata: {},
	cfgTestInfo: {
		name: 'RND-TEST',
		flagType: 'NA',
...
// ================================================================================================== //
	show: function( queryPanelController, key, extData, isModifier, fieldIndex) {
		//if (Object.isUndefined(i2b2.VARVIEW.model.queryCurrent.panels[panelIndex])) { return; }
		var fd = i2b2.VARVIEW.view.modalLabValues.formdata;
		//var dm = i2b2.VARVIEW.model.queryCurrent.panels[panelIndex];
		// save info for callback
		//this.qpi = panelIndex;
		this.cpc = queryPanelController;
		i2b2.VARVIEW.view.modalLabValues.isModifier = isModifier;
		//i2b2.VARVIEW.view.modalLabValues.itemNumber = extData.itemNumber;
		//this.isModifier = isMod;
		this.key = key;
		this.i2b2Data = extData;
		this.fieldIndex2 = fieldIndex;
		...
		if (!this.sd) {
			this.sd = new YAHOO.widget.SimpleDialog("itemLabRange", {
				...
				buttons: [{
					...
					handler: 
						(function() {
							var closure_qpi = i2b2.VARVIEW.view.modalLabValues.qpi;
							var closure_cpc = i2b2.VARVIEW.view.modalLabValues.cpc;
							var closure_key = i2b2.VARVIEW.view.modalLabValues.key;
							var closure_number = i2b2.VARVIEW.view.modalLabValues.itemNumber;
							// submit value(s)
							if (this.submit()) {
								if (i2b2.VARVIEW.view.modalLabValues.isModifier) {
											i2b2.VARVIEW.model.conceptRecords[i2b2.VARVIEW.view.modalLabValues.fieldIndex2].ModValues = i2b2.VARVIEW.view.modalLabValues.i2b2Data.ModValues;
										} else {
											//i2b2.VARVIEW.model.conceptRecords[i2b2.VARVIEW.view.modalLabValues.fieldIndex2].LabValues = i2b2.VARVIEW.view.modalLabValues.i2b2Data.LabValues;
                                                                                  //i2b2.VARVIEW.model.conceptRecords[i2b2.VARVIEW.view.modalLabValues.fieldIndex2].LabValues = new Object()
                                                                                  i2b2.VARVIEW.model.conceptRecords[i2b2.VARVIEW.view.modalLabValues.fieldIndex2].LabValues =  i2b2.VARVIEW.view.modalLabValues.i2b2Data.LabValues;
										}
								
                                                                // MTL: TODO: trying to update dropped concept with correct display name once popup has been submitted
	                                                        $("VARVIEW-CONCPTDROP-" + i2b2.VARVIEW.view.modalLabValues.fieldIndex2).innerHTML = i2b2.VARVIEW.buildConceptDisplayName(i2b2.VARVIEW.view.modalLabValues.fieldIndex2);
								// update the panel/query tool GUI
								//i2b2.VARVIEW.ctrlr.QT.doSetQueryName.call(this, '');
								//i2b2.VARVIEW.conceptsRender();
								//queryPanelController._renameConcept(closure_key, i2b2.VARVIEW.view.modalLabValues.isModifier, pd);

								//queryPanelController._renameConcept(i2b2.VARVIEW.view.modalLabValues.i2b2Data.itemNumber, i2b2.VARVIEW.view.modalLabValues.isModifier, pd);
								
								delete i2b2.VARVIEW.view.modalLabValues.isModifier;
			...
			YAHOO.util.Event.addListener("mlvfrmStrValue", "keypress", (function(e) {
				...
				var msl = i2b2.VARVIEW.view.modalLabValues.cfgTestInfo.valueValidate.maxString;
				if (!msl || this.value.length < msl) {
					delete i2b2.VARVIEW.view.modalLabValues.formdata.lastValidStr;
					return true;
				} else {
					if (!i2b2.VARVIEW.view.modalLabValues.formdata.lastValidStr) {
						i2b2.VARVIEW.view.modalLabValues.formdata.lastValidStr = this.value;
					}
					return true;
				}
			...
			YAHOO.util.Event.addListener("mlvfrmStrValue", "keyup", (function(e) {
				// anonymous function
				if (i2b2.VARVIEW.view.modalLabValues.formdata.lastValidStr) {
					this.value = i2b2.VARVIEW.view.modalLabValues.formdata.lastValidStr;
				}
			}));
		}
...
// ================================================================================================== //
	changeHandler: function(e) {
		var dm = i2b2.VARVIEW.view.modalLabValues.cfgTestInfo;
		var fd = i2b2.VARVIEW.view.modalLabValues.formdata;
		...
		tn.blur();
		// save the changes
		i2b2.VARVIEW.view.modalLabValues.formdata = fd;
		i2b2.VARVIEW.view.modalLabValues.Redraw();
	},
	
// ================================================================================================== //
	cfgByMetadata: function(refXML){
		// load and process the xml info
		i2b2.VARVIEW.view.modalLabValues.formdata.ignoreChanges = true;
		var dm = i2b2.VARVIEW.view.modalLabValues.cfgTestInfo;
		var fd = i2b2.VARVIEW.view.modalLabValues.formdata;
		fd.selectedType= "NONE";
		...
		} else if (i2b2.VARVIEW.view.modalLabValues.isModifier) {
		...
		i2b2.VARVIEW.view.modalLabValues.formdata.ignoreChanges = false;
		i2b2.VARVIEW.view.modalLabValues.setUnits();
		i2b2.VARVIEW.view.modalLabValues.Redraw();
	},
...
// ================================================================================================== //
	Redraw: function(){
		if (i2b2.VARVIEW.view.modalLabValues.formdata.ignoreChanges) return;
		i2b2.VARVIEW.view.modalLabValues.formdata.ignoreChanges = true;
		var fd = i2b2.VARVIEW.view.modalLabValues.formdata;
		var dm = i2b2.VARVIEW.view.modalLabValues.cfgTestInfo;
...
// ================================================================================================== //
	ValidateSave: function() {
		...
		switch (fd.selectedType) {
			case "NONE":
			    if (i2b2.VARVIEW.view.modalLabValues.isModifier) {
					delete i2b2.VARVIEW.view.modalLabValues.i2b2Data.ModValues;
				} else {
					delete i2b2.VARVIEW.view.modalLabValues.i2b2Data.LabValues;					
				}
				return true;
				break;
			case "FLAG":
		...
		if (i2b2.VARVIEW.view.modalLabValues.isModifier) {
			if (tmpLabValue) {
				i2b2.VARVIEW.view.modalLabValues.i2b2Data.ModValues = tmpLabValue;
			} else {
				delete i2b2.VARVIEW.view.modalLabValues.i2b2Data.ModValues;
			}
		} else { 
			if (tmpLabValue) {
				i2b2.VARVIEW.view.modalLabValues.i2b2Data.LabValues = tmpLabValue;
			} else {
				delete i2b2.VARVIEW.view.modalLabValues.i2b2Data.LabValues;
			}
		}
